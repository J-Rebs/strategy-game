...
pub fn create_hex_prism_mesh(radius: f32, height: f32) -> Mesh {
    ...
    // 1. Generate Pointy-topped perimeter offsets
    ...
    // 3. BOTTOM FACE (Triangle Fan, winding inverted)
    ...
    // 4. SIDE FACES (Flat shaded rects)
    for i in 0..6 {
        let i_next = (i + 1) % 6;
